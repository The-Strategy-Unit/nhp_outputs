...
test_that("ui is created correctly", {
  ...
  expect_args(m, 7, "principal_capacity_requirements")
  expect_args(m, 8, "model_core_activity")
  expect_args(m, 9, "model_results_distribution")
  expect_args(m, 10, "model_results_capacity")
})
