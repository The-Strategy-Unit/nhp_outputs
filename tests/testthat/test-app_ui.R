...
test_that("ui is created correctly", {
  ...
  expect_args(m, 4, "principal_summary")
  expect_args(m, 5, "principal_high_level")
  expect_args(m, 6, "principal_detailed")
  expect_args(m, 7, "principal_change_factor_effects")
  expect_args(m, 8, "principal_capacity_requirements")
  expect_args(m, 9, "model_core_activity")
  expect_args(m, 10, "model_results_distribution")
  expect_args(m, 11, "model_results_capacity")
})
