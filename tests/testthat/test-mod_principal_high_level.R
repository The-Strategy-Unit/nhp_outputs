...
principal_high_level_expected <- tibble::tribble(
  ...
  "ip_maternity_admission",           1100,       1200,
...
summary_data_expected <- tibble::tribble(
  ...
  2018, 1100, "ip", "Maternity Admission", "2018/19",
  ...
  2019, 1150, "ip", "Maternity Admission", "2019/20",
  ...
  2020, 1200, "ip", "Maternity Admission", "2020/21",
