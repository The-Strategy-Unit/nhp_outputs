...
For details, [the model project information site](https://connect.strategyunitwm.nhs.uk/nhp/project_information) contains an overview, user guide and methodology.
...
#### Impact of changes (trust-level)

The data in this section is presented at trust level only. The results should be regarded as rough, high-level estimates of the number of rows added/removed due to each parameter. See [the model project information site](https://connect.strategyunitwm.nhs.uk/nhp/project_information/user_guide/glossary.html) for definitions of terms.
...
##### Inpatients (trust-level)

###### Bed days (trust-level)
...
##### Outpatients (trust-level)

###### Attendances (trust-level)
