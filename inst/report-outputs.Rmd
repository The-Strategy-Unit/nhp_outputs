...
<!-- Note: section hidden due to ongoing time-profile discussions
...
```{r}
#| label: pp-summary-by-year-plot-ip-admissions

principal_high_level_summary_data |> 
  possibly_mod_principal_high_level_plot(
    activity_type = "ip",
    measure = "admissions"
  )
```
...
```{r}
#| label: pp-summary-by-year-plot-ip-beddays
