...
---
subtitle: "Scenario: `r params$r$params$scenario` (`r selected_sites` selected)"
---

# Notes

This report provides the outputs (tables and charts) for the selected model scenario (`r params$r$params$scenario`) and the following sites: `r selected_sites`.

Note that A&E results are only available at trust level. Tables and charts won't be shown if there's insufficient data to produce them.
