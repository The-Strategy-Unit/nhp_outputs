...
params$r |>
  reskit::shim_results() |>
  reskit::compile_principal_pod_data(sites = params$sites) |>
...
params$r |>
  reskit::shim_results() |>
  reskit::compile_principal_los_data(measure = "beddays", sites = params$sites) |>
...
params$r |>
        ...
        reskit::make_individual_cf_plot(
          x_axis_label = snakecase::to_title_case("beddays")
        )
```
...
params$r |>
        ...
        reskit::make_individual_cf_plot(
          x_axis_label = snakecase::to_title_case("admissions")
        )
```
...
params$r |>
        ...
        reskit::make_individual_cf_plot(
          x_axis_label = snakecase::to_title_case("attendances")
        )
```
...
params$r |>
        ...
        reskit::make_individual_cf_plot(
          x_axis_label = snakecase::to_title_case("tele_attendances")
        )
```
...
params$r |>
        ...
        reskit::make_individual_cf_plot(
          x_axis_label = snakecase::to_title_case("arrivals")
        )
```
...
atpmo_agg <- get_activity_type_pod_measure_options() |>
  ...
  tidyr::crossing(agg_col = c("age_group", "tretspef_grouped"))
