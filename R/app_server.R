...
app_server <- function(input, output, session) {
  ...
  mod_principal_summary_server("principal_summary", selected_model_run_id, selected_site)
  mod_principal_high_level_server("principal_high_level", selected_model_run_id, selected_site)
  mod_principal_detailed_server("principal_detailed", selected_model_run_id, selected_site)
  ...
  mod_model_core_activity_server("model_core_activity", selected_model_run_id, selected_site)
  mod_model_results_distribution_server("model_results_distribution", selected_model_run_id, selected_site)
